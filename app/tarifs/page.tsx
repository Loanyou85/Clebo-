...
export default function TarifsPage() {
  return (
    <div className="container-page py-16 max-w-2xl">
      ...
      <p className="prose-clebo text-sourdine mb-12">
      ...
      <div className="flex flex-col gap-4 mb-12">
        <div className="card-surface p-6">
          ...
          <ul className="flex flex-col gap-2 text-sm text-sourdine mb-5">
        ...
        <div className="card-surface p-6 border-signal">
          ...
          <p className="text-sm text-sourdine mb-4">Accès à vie, sans abonnement</p>
          <ul className="flex flex-col gap-2 text-sm text-sourdine mb-5">
        ...
        <div className="card-surface p-6">
          ...
          <p className="text-sm text-sourdine mb-4">Suivi Clebo, résiliable en un clic</p>
          <ul className="flex flex-col gap-2 text-sm text-sourdine">
          ...
          <p className="text-sm text-sourdine mt-4">
